...
-- MAKE SURE YOU ARE LOGGED IN to your TAL application first!
...
BEGIN
    ...
    IF current_user_id IS NULL THEN
        RAISE EXCEPTION 'ERROR: No authenticated user found. Please login to your TAL application first!';
    END IF;
    
    IF current_email IS NULL THEN
        RAISE EXCEPTION 'ERROR: User email not found. Please check your authentication.';
    END IF;
